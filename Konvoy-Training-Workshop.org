...
- Deploy a stateful application that requires orchestration to deploy (ZooKeeper,
then Kafka)
...
**** Verify installation
     ...
     #+begin_example
     KUDO Version: version.Info{GitVersion:"0.5.0", GitCommit:"f9f6aa85", BuildDate:"2019-08-02T15:05:56Z", GoVersion:"go1.12.5", Compiler:"gc", Platform:"linux/amd64"}
     #+end_example
...
#+begin_src sh
  cd /home/myuser/operators/repository/zookeeper/operator
  kubectl kudo install . --instance=zk
#+end_src
#+begin_example
...
information about pods, deployments, ...

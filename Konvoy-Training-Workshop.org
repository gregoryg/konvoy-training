...
If you use your laptop, you need to have Docker installed.
  ...
  + Windows
       Click on the [[https://download.docker.com/win/stable/Docker%20for%20Windows%20Installer.exe][Docker Dektop installer .exe file]]
...
To exit =telnet=, type =Control-]=, then =quit=

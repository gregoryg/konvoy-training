...
**** After installation
     Check =kubectl= was successfully installed and in your path
     #+begin_src sh
     kubectl version
     #+end_src
*** =helm=
    TODO: Add installation instructions for helm
*** wget/curl
...
** Lab Steps When Konvoy is deployed on AWS, a =StorageClass= is created
...
information about these objects like you can get information about
pods, deployments, ...
